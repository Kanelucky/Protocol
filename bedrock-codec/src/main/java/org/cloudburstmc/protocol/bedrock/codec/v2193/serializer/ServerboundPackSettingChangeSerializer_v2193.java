...
public class ServerboundPackSettingChangeSerializer_v2193 extends ServerboundPackSettingChangeSerializer_v844 {
    ...
    public static final ServerboundPackSettingChangeSerializer_v2193 INSTANCE =
            new ServerboundPackSettingChangeSerializer_v2193();
    ...
    public void serialize(ByteBuf buffer, BedrockCodecHelper helper, ServerboundPackSettingChangePacket packet) {
        ...
        int type = value instanceof Float
                ? 0
                : value instanceof Boolean ? 1 : value instanceof String ? 2 : value instanceof List ? 3 : -1;
