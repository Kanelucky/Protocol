 ...
 * @param defaultBiome  the dimension's default biome
 */
public record DimensionDefinition(String id, int maximumHeight, int minimumHeight, int generatorType, int dimensionType, UUID packId, String defaultBiome) {
    ...
    public DimensionDefinition(String id, int maximumHeight, int minimumHeight, int generatorType, int dimensionType) {
