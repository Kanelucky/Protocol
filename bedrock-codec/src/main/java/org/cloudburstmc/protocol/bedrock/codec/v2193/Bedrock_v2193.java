...
public class Bedrock_v2193 extends Bedrock_v2169 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v2169.CODEC.toBuilder()
            ...
            .updateSerializer(
                    ClientboundAttributeLayerSyncPacket.class, ClientboundAttributeLayerSyncSerializer_v2193.INSTANCE)
            ...
            .updateSerializer(
                    ...
                    new ServerboundDiagnosticsSerializer_v2193(MEMORY_CATEGORY_TYPES))
            .updateSerializer(
                    ServerboundPackSettingChangePacket.class, ServerboundPackSettingChangeSerializer_v2193.INSTANCE)
            .registerPacket(
                    SetPlayerFurnaceOptionsPacket::new,
                    SetPlayerFurnaceOptionsSerializer_v2193.INSTANCE,
                    351,
                    PacketRecipient.CLIENT)
            .registerPacket(
                    RecordStartedPacket::new, RecordStartedSerializer_v2193.INSTANCE, 352, PacketRecipient.CLIENT)
            .build();
}
