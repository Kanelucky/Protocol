...
public class Bedrock_v2192 extends Bedrock_v2169 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v2169.CODEC.toBuilder()
            ...
            .updateSerializer(
                    ClientboundAttributeLayerSyncPacket.class, ClientboundAttributeLayerSyncSerializer_v2192.INSTANCE)
            ...
            .updateSerializer(
                    ServerboundDiagnosticsPacket.class,
                    new ServerboundDiagnosticsSerializer_v2192(MEMORY_CATEGORY_TYPES))
            .updateSerializer(
                    ServerboundPackSettingChangePacket.class, ServerboundPackSettingChangeSerializer_v2192.INSTANCE)
            .registerPacket(
                    SetPlayerFurnaceOptionsPacket::new,
                    SetPlayerFurnaceOptionsSerializer_v2192.INSTANCE,
                    351,
                    PacketRecipient.CLIENT)
            .registerPacket(
                    RecordStartedPacket::new, RecordStartedSerializer_v2192.INSTANCE, 352, PacketRecipient.CLIENT)
            .build();
}
